...
import Activity11.Card;
import Activity11.Deck;
...
public abstract class Board {
	 ...
	 */
	private Activity11.Card[] cards;

	/**
	 * The deck of cards being used to play the current game.
	 */
	private Activity11.Deck deck;
	...
	public Board(int size, String[] ranks, String[] suits, int[] pointValues) {
		cards = new Activity11.Card[size];
	 ...
	 */
	public Activity11.Card cardAt(int k) {
		return cards[k];
	}
	 ...
	 *         false otherwise.
	 */
	public abstract List<Integer> anotherPlayIsPossible();
